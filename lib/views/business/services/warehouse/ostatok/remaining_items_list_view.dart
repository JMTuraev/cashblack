                              ...
                              children: [
                                Expanded(
                                  child: isShow[0] == true
                                      ? _ListWidget(
                                          selections: selections,
                                          warehouseItems: model.skladRemainings,
                                        )
                                      : isShow[1] == true
                                          ? _GridWidget(
                                              selections: selections,
...
class _ListWidget extends StatefulWidget {
  ...
  final List<SkladRemaining> warehouseItems;
        ...
        return Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text(
                  widget.warehouseItems[index].warehouseItem.name,
                ...
                Text(
                  widget.warehouseItems[index].warehouseItem.category.name,
                  style: const TextStyle(
            ...
            Text(
              //todo
              '${widget.warehouseItems[index].quantity.toInt()} ${widget.warehouseItems[index].warehouseItem.unit.name}',
              style: const TextStyle(
