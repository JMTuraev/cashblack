...
class SellerStatisticsView extends StatefulWidget {
  const SellerStatisticsView({super.key});

  @override
  State<SellerStatisticsView> createState() => _SellerStatisticsViewState();
}

class _SellerStatisticsViewState extends State<SellerStatisticsView> {
  bool summa = true;
  bool cashback = false;
  ...
  void initState() {
    ...
    // mergedList
    //   ..addAll(context.read<SellerViewModel>().cashbackAndWithdraws!.withdraw)
    //   ..addAll(context.read<SellerViewModel>().cashbackAndWithdraws!.cashback);
  ...
  Widget build(BuildContext context) {
    ...
    final body = IndexedStack(
      ...
      children: [
        _CashbackListWidget(
          mergedList: context.read<SellerViewModel>().mergedList,
        ),
...
class _CashbackListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (context.watch<SellerViewModel>().isLoadingStats) {
